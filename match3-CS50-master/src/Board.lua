...
function Board:calculateMatches()
    ...
    for y = 1, 8 do
        ...
        --Update: Shiny Tile - if tile in match is shiny
        ...
        for x = 2, 8 do
            ...
            if self.tiles[y][x].color == colorToMatch then
                ...
                if matchNum >= 3 then
                    ...
                    -- Update: Shiny Tile: if tile in match is shiny add whole row to match table
                    if shinyMatch then
                        for rowX = 1, 8 do
        ...
        for y = 2, 8 do
            if self.tiles[y][x].color == colorToMatch then
                ...
                if matchNum >= 3 then
                    ...
                    -- Update: Shiny Tile: if tile in match is shiny add whole column to match table
                    if shinyMatch then
                        for columnY = 1, 8 do
